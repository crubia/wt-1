...
cd /tmp
wget http://10.128.19.55:8888/server/create_alfresco_db.sql -O /tmp/create_alfresco_db.sql
wget http://10.128.19.55:8888/server/grant_alfresco_user.sql -O /tmp/grant_alfresco_user.sql
...
sudo -S cd /tmp
sudo -S wget http://10.128.19.55:8888/server/alfresco-community-4.0.d-installer-linux-x64.bin -O /tmp/alfresco-community-4.0.d-installer-linux-x64.bin
