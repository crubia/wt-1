...
cd /tmp
wget http://172.17.0.1:8000/create_alfresco_db.sql -O /tmp/create_alfresco_db.sql
wget http://172.17.0.1:8000/grant_alfresco_user.sql -O /tmp/grant_alfresco_user.sql
...
sudo -S cd /tmp
sudo -S wget http://172.17.0.1:8000/alfresco-community-4.0.d-installer-linux-x64.bin -O /tmp/alfresco-community-4.0.d-installer-linux-x64.bin
