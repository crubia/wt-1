...
cd /tmp
sudo -S wget http://10.200.3.106:8888/server/create_redmine_db.sql -O /tmp/create_redmine_db.sql
sudo -S wget http://10.200.3.106:8888/server/grant_redmine_user.sql -O /tmp/grant_redmine_user.sql
...
wget http://10.200.3.106:8888/server/redmine.service -O /tmp/redmine.service
sudo -S cp /tmp/redmine.service /usr/lib/systemd/system/redmine.service
sudo -S systemctl enable redmine.service